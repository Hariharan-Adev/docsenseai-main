...
def _resolve_local_vector_path(value: str) -> str:
    """Resolve configured local vector storage from the project root."""
    if not value:
        return value
...
class QdrantVectorStore(VectorStore):
    ...
    def __init__(self) -> None:
        ...
        local_path = _resolve_local_vector_path(local_path)
        mode = requested_mode
        if mode == "auto":
