...
from app.services.rag_diagnostics import trace_stage
...
def search_chunks(
    ...
    if not retrieval_query:
        return []
    with trace_stage("sqlite_database_hydration_ms"):
    ...
    with trace_stage("embedding_creation_ms"):
        vector = create_embeddings([retrieval_query])[0]
    with trace_stage("vector_search_ms"):
